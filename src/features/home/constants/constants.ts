export enum FIRST_SCREEN_LABELS {
  EXTRA_LAYER = 'Add An Extra Layer Of',
  SECURITY = 'Security',
  YOUR_LIFE = 'To Your Life',
  GET_CYBERGUARD = 'Get CyberGuard',
  USE_TO_HELP = 'CyberGuard uses AI to help you fight the spread of fake news',
}

export enum SECOND_SCREEN_LABELS {
  WHY = 'Why ',
  ...
  DESCRIPTION = 'Lorem ipsum dolor sit amet, consectetur \n' +
    ...
    'feugiat in. Morbi tempus iaculis urna id volutpat \n' +
    'lacus laoreet non curabitur. Molestie nunc non \n' +
    'blandit massa enim nec dui nunc mattis. In \n' +
